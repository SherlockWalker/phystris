...
def print_result(result, output, timestamp): #For now I don't use timestamp, it might error I don't care
    ...
    lastFrame = drawDetection(lastFrame, detection.detections)
    lastFrame = drawStatusOverlays(lastFrame, detection.isSoftDropping, detection.isJumping, detection.jumpStartTime, detection.HDmessageTime, keysDict)
...
with PoseLandmarker.create_from_options(options) as landmarker:
    ...
    cv2.resizeWindow("phystris", fx, fy)
